...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('pembudidaya') }}">Laporan Individu</a></div>
        <div class="breadcrumb-item">Table Laporan Individu</div>
    </div>
</div>
<!-- breadcrumbs-end -->
@endsection
                ...
                <div class="row">
                    <div class="col-6">
                        <dl class="row">
                            ...
                            <dd class="col-sm-8">{{$dataPembudidaya->nama_pembudidaya}}</dd>
                            <dt class="col-sm-4">NIK</dt>
                            <dd class="col-sm-8">{{$dataPembudidaya->nik}}</dd>
                            <dt class="col-sm-4">Jenis Kelamin</dt>
                            <dd class="col-sm-8">{{$dataPembudidaya->jenis_kelamin}}</dd>
                            <dt class="col-sm-4">Tanggal Lahir</dt>
                            <dd class="col-sm-8">@convertDate($dataPembudidaya->tanggal_lahir)</dd>
                    ...
                    <div class="col-6">
                        <dl class="row">
                            ...
                            <dd class="col-sm-8">{{$dataPembudidaya->contact}}</dd>
                            <dt class="col-sm-4">Desa</dt>
                            <dd class="col-sm-8">{{$dataPembudidaya->desa->nama_desa}}</dd>
                            <dt class="col-sm-4">Alamat</dt>
                            <dd class="col-sm-8">{{$dataPembudidaya->alamat}}</dd>
                        </dl>
                    </div>
                </div>
            </div>
